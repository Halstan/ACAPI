...
class WeaponController constructor(
    ...
    fun findAll(): ResponseEntity<List<Weapon>>{
    ...
    fun addWeapon(@RequestBody @Valid weapon: Weapon): ResponseEntity<Weapon>{
    ...
    fun findWeapon(@PathVariable idWeapon: Int): ResponseEntity<Optional<Weapon>>{
    ...
    fun updateWeapon(@RequestBody @Valid weapon: Weapon): ResponseEntity<Weapon>{
    ...
    fun deleteWeapon(@PathVariable idWeapon: Int) {

...
class CountryController constructor(
    ...
    private fun addCountry(@RequestBody country: @Valid Country): ResponseEntity<Country> {
    ...
    private fun findCountry(@PathVariable idCountry: Int): ResponseEntity<Optional<Country>>{
    ...
    private fun deleteCountry(@PathVariable idCountry: Int): ResponseEntity<Unit>{
